    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        echo "\" method=\"post\">
            ...
            <div class=\"create-title\">
                ...
                <input type=\"text\" class=\"create-title-content\" name=\"book[title]\" required/>
            </div>
            <div class=\"create-bookitem\">
                <div class=\"create-bookitem-label\">AUTHOR</div>
                <input type=\"text\" class=\"create-bookitem-content\" name=\"book[author]\" required>
            </div>
            <div class=\"create-bookitem\">
                <div class=\"create-bookitem-label\">PRICE</div>
                <input type=\"number\" min=\"1\" step=\"any\" class=\"create-bookitem-content\" name=\"book[price]\" required/>
            </div>
...
{% endblock %}", "library/create.html.twig", "C:\\Users\\Mitko\\Desktop\\SoftUni\\Technology-Fundamentals-September-2018\\Preparation Exam December 2018\\Library\\app\\Resources\\views\\library\\create.html.twig");
    }
}
