...
class srcDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CreatePostType' => function () {
            return ($this->privates['App\Form\CreatePostType'] ?? $this->privates['App\Form\CreatePostType'] = new \App\Form\CreatePostType());
