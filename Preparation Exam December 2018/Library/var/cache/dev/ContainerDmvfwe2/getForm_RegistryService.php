...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\BookType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\BookType']) ? $this->services['AppBundle\Form\BookType'] : $this->services['AppBundle\Form\BookType'] = new \AppBundle\Form\BookType()) && false ?: '_'};
